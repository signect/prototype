...
<head>
	...
	<title>signet</title>
	<meta name='application-name' content='signet'/>
	<meta name='msapplication-tooltip' content='signet' />
	<meta id='meta_og_title' property='og:title' content='signet' />
	...
	<!-- <link rel='stylesheet' type='text/css' href='/tmpl/index_assets/css/im_component.css'/> -->
	<!-- <link rel='stylesheet' type='text/css' href='/tmpl/index_assets/css/alarm_menu.css'/> -->
	...
	<!-- <link rel='stylesheet' type='text/css' href='/tmpl/index_assets/css/chosen.css'/>
	<link rel='stylesheet' type='text/css' href='/tmpl/index_assets/css/chosenImage.css'/> -->
	<link rel='stylesheet' type='text/css' href='/tmpl/index_assets/css/style.css'/>
	<!-- <link rel='stylesheet' type='text/css' href='/tmpl/index_assets/css/pretendardvariable.css'/> -->
	<!-- <link rel='stylesheet' type='text/css' href='/tmpl/index_assets/css/pretendard.css'/> -->
	<!-- <link rel='stylesheet' type='text/css' href='/tmpl/index_assets/css/froala-emoji-tap_style.css'/> -->
	<!-- <link rel='stylesheet' type='text/css' href='/css/custom.cm?1674089376'/> -->
	<link rel='stylesheet' type='text/css' href='/tmpl/index_assets/css/tailwind.css'/>
	<!-- <link rel='stylesheet' type='text/css' href='/tmpl/index_assets/css/emoji.css'/> -->
...
<header id="doz_header_wrap" >
		...
		<div class="new_org_header _new_org_header">
					...
					<div data-type="section-wrap" class="inline-section-wrap fixed_transform" id="s20230119d92cb9b0e1aa6">
						...
						<div data-type="inside" class="inline-inside _inline-inside">
							<div data-type="section" class="inline-section" section-code="s20230119d92cb9b0e1aa6">
													...
													<div class="viewport-nav desktop _main_menu">
														...
														<li class="dropdown _show_m202301191dfcdc851c39e" style="" id="dropdown_m202301191dfcdc851c39e" data-code="m202301191dfcdc851c39e">
															<a href="/archive" class="fixed_transform dropdown-toggle disabled _header_dropdown   _fade_link " data-url="archive" data-toggle="dropdown"> 
																<span class="_txt_m202301191dfcdc851c39e plain_name"	data-hover="">Archive</span>
															</a>
														</li>
														<li class="dropdown _show_m2023011900a8eb95a5cef" style="" id="dropdown_m2023011900a8eb95a5cef" data-code="m2023011900a8eb95a5cef">
															<a href="/Crew" class="fixed_transform dropdown-toggle disabled _header_dropdown   _fade_link " data-url="Crew" data-toggle="dropdown"> 
																<span class="_txt_m2023011900a8eb95a5cef plain_name" data-hover="">Crew</span>
															</a>
														</li>
													</div>
												</ul>
								...
								<!-- 템플릿별 레이아웃 구조 -->
								<!-- 템플릿별 레이아웃 구조 -->
								<!-- <div data-type="col-group" data-col-group="right" class="inline-col-group inline-col-group-right" style="width: 237px;">
									<div data-type="grid" class="inline-col">
										<div data-type="widget" id="w2023011923e43638a0f11" class="inline-widget">
									...
									<div data-type="grid" class="inline-col">
										<div data-type="widget" id="w202301191a5a06246b0a6" class="inline-widget">
												...
												<div class="widget inline_widget search_btn">
													<div class="search_type fixed_transform search_btn_type01">
														<div class="inline-blocked holder">
															<form class=" icon_on" action="/search" method="get" id="inline_s_form_w202301191a5a06246b0a6">
																<input class="search_btn_form" name="keyword" style="display: none" placeholder="Search" value="" title="검색"> 
																	<a class="fixed_transform inline-blocked " href="#" onclick="SITE_SEARCH.openSearch(search_option_data_w202301191a5a06246b0a6);">
									...
									<div data-type="grid" class="inline-col">
										<div data-type="widget" id="w20230119cf9388e7221ae" class="inline-widget">
											<div class="_widget_data" data-widget-type="inline_login_btn">
												<div class="widget inline_widget login_btn button  button_text txt_l text-xx-small">
													<div>
														<div class="inline-blocked login_btn_item ">
															<a class="_fade_link   btn_text btn_e4D42kp2mF   btn_custom " href="javascript:;" onclick="SITE_MEMBER.openLogin('L2luZGV4', 'null', null, 'Y');" style="border-radius: 0px;" data-toggle="tooltip" data-placement="bottom" data-original-title="Login">
																<span class="sr-only">로그인 위젯 문구</span>
																<span class="icon_class ">
																	<i class="fixed_transform simple icon-user" aria-hidden="true"></i>
																</span>
															</a>
														</div>
													</div>
				...
				<!-- <div id="inline_header_mobile" style="min-height: 30px;"
					...
					<div data-type="section-wrap"
						...
						<div class="section_bg_color _section_bg_color fixed_transform" style="position: absolute; left: 0; top: 0; right: 0; bottom: 0;"></div>
						<div data-type="inside" class="inline-inside _inline-inside">
							<div data-type="section" class="inline-section" section-code="s2023011992826f629d381">
								<div data-type="col-group" data-col-group="left" class="inline-col-group inline-col-group-left" style="width: 77px;">
									<div data-type="grid" class="inline-col">
										<div data-type="widget" id="w202301190f4903303d348"	class="inline-widget">
											<div class="_widget_data" data-widget-type="inline_menu_btn">
												<div class="widget inline_widget icon_type_menu st00">
													<a href="javascript:;"
														...
														id="inline_menu_alarm_badge"></span> 
								...
								<div data-type="col-group" data-col-group="center" class="inline-col-group inline-col-group-center">
									<div data-type="grid" class="inline-col">
										<div data-type="widget" id="w20230119ca1fc77800a37" class="inline-widget">
											<div class="_widget_data" data-widget-type="inline_logo">
												<div class="widget inline_widget logo  text_inline" id="logo_w20230119ca1fc77800a37">
													<div class="logo_title ">
														<a class=" fixed_transform" style="display: block" href="/">signet</a>
													</div>
												</div>
											</div>
										</div>
														...
														<div class="inline-blocked holder">
															<form class=" icon_on" action="/search" method="get"
																...
																<input class="search_btn_form" name="keyword"
																	...
																	title="검색"><a
																	class="fixed_transform inline-blocked " href="#"
																	onclick="SITE_SEARCH.openSearch(search_option_data_w202301190f624af74ed3d);"><i
							...
							<div class="mobile_carousel_nav fixed_transform _mobile_nav "
								...
								<div
									...
									<div class="nav-item _item  active   "
										...
										<a href="/index" class=" _fade_link " style=""> <span
											class="plain_name" data-hover="">Overview</span>
										</a>
									</div>
									<div class="nav-item _item   "
										data-code="m202301191dfcdc851c39e" data-url="archive">
										<a href="/archive" class=" _fade_link " style=""> <span
											class="plain_name" data-hover="">Archive</span>
										</a>
									</div>
									<div class="nav-item _item   "
										data-code="m2023011900a8eb95a5cef" data-url="Crew">
										<a href="/Crew" class=" _fade_link " style=""> <span
											class="plain_name" data-hover="">Crew</span>
										</a>
									</div>
								</div>
							</div>
													...
													<h6>
														<span style="color: rgb(255, 255, 255);"> <span
															style="font-family: 'Times New Roman', Times, serif, 바탕, batang;">
																...
																faucibus nibh et justo cursus id rutrum. </span>
														</span>
													</h6>
												</div>
											</div>
	...
	<script src='/tmpl/index_assets/js/bootstrap.min.js?1630317768'></script>
<!--[if lte IE 9]>
